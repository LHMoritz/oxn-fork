...
from TrainAndTestModel import TraceModel
...
class ModelController:
     ...
     def __init__(self, variables : list[TraceResponseVariable], experiment_id : str , model_path :str):
          ...
          self.model = self._load_model(model_path, TraceModel(nn.CrossEntropyLoss(), constants.MODEL_DIMENSIONS, [nn.ReLU(), nn.ReLU(), nn.ReLU(), nn.Softmax()]))
